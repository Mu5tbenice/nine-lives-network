...
**Partially resolved 2026-04-24 in PR #? — portrait column → horizontal header strip; `#mob-buttons` lifted out of `#mob-portrait-col` to a sibling bottom actions bar. `#mobile-hud-root` restacks row → column so the tab content gets full viewport width. Addresses items 2, 5.**
