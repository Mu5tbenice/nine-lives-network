...
**Status: PARTIALLY RESOLVED.** Items 1–4 shipped 2026-04-23 (PRs #183, #184, #185, #?). Only item 5 (deploy-status pill §9.40) remains — a net-new HUD element, not a refactor. The §9.41 conflation is effectively resolved.
