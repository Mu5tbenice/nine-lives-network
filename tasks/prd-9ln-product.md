...
**Partially resolved 2026-04-24 in PR #? — action button hierarchy: SWAP gold (neutral), EXIT red (destructive), AUTO explicit ON/OFF pill with sliding dot and `.auto-on` state class. Addresses item 4.**
