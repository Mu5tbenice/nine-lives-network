...
**Partially resolved 2026-04-24 in PR #? — tab label consistency (all 4 tabs get icon + text) + active-tab underline indicator + chat send button treatment (gold-outlined pill with visible input field). Addresses items 7, 12.**
