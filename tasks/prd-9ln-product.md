...
**Status: PARTIALLY RESOLVED.** Items 1 + 2 shipped 2026-04-23 (PRs #183 + #?). Items 3–5 still OPEN — item 4 (auto-rejoin UX flip) is the highest-user-visible remaining piece; items 3 + 5 are polish.
