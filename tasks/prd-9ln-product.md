...
**Resolved 2026-04-21 in PR #?.** Seven commits, UI-scoped (no server or schema changes in §9.49 — per-zone metrics tracked separately as §9.50):
...
**Resolved 2026-04-21 in PR #?.** Server adds the persistence layer; client consumes it as authoritative with localStorage retained as offline fallback. Two client sub-bugs fixed in the same commit.
