...
**Status: PARTIALLY RESOLVED.** Items 1, 2, + 4 shipped 2026-04-23 (PRs #183, #184, #185). Items 3 + 5 still OPEN — both polish (sidebar label rewrite, deploy-status pill §9.40).
