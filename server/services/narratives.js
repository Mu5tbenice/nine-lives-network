...
const narratives = [
...

  {
    ...
    theme: "Epstein parody — the most important prisoner in Nethara was found dead under impossible circumstances. His list of powerful names has gone missing. Communities race to find the list before it disappears forever.",
...

  {
    ...
    theme: "Flat earth parody — a confident wizard says Nethara is flat and has organized an expedition to 'the edge.' Communities profit from the accidentally useful exploration of new territory.",
...

  {
    ...
    tweet_4_prompt: "Resolve — crystal wars over. Barely. Announce winner. Several wizards trapped in a glass case of emotion. Trident wizard still at large. Show final scoreboard, name MVP. End with 'Full intel at 9lv.net' — stay classy, Nethara.",
