...
const narratives = [
...

  {
    ...
    theme: "Conspiracy parody — two ancient crystal towers collapsed simultaneously under suspicious circumstances. Guilds race to salvage scrolls from the rubble before the Council seals the site.",
...

  {
    ...
    theme: "Epstein parody — the most important prisoner in Nethara was found dead under impossible circumstances. His list of powerful names has gone missing. Guilds race to find the list before it disappears forever.",
    tweet_1: "🚨 The most important prisoner in Nethara was found dead in his cell.\n\nBoth anti-magic wards failed simultaneously. Both guards fell asleep at the same hour. Surveillance crystals went dark for exactly eleven minutes.\n\nHe had a list of names. The list is missing.\n\nWhich guild finds the list first?\nRally your guild — reply as your Nine! 🐱‍👤",
    ...
    tweet_3_prompt: "Build urgency — the Council is about to seal Chambers Keep permanently. The second prisoner was transferred, then un-transferred, then the paperwork vanished. Show updated standings. Play up how close it is between top guilds. The names could reshape the realm. Time is running out.",
    tweet_4_prompt: "Resolve — Chambers Keep has been sealed by Council order. Announce the winning guild as the one that recovered the most intelligence before the doors closed. Official verdict: 'self-inflicted spell damage.' The second prisoner's paperwork vanished. Show final scoreboard, name MVP. End with 'Full intel at 9lv.net' — nothing happened at Chambers Keep, this is the official position forever.",
...

  {
    ...
    tweet_3_prompt: "Escalate — the frogs are organizing, one opened a door today. The Guild is about to seal the area for 'routine maintenance.' Show updated standings. Create urgency about collecting specimens before the area is closed. If guilds are close, mention the frogs seem to be picking sides.",
...

  {
    ...
    theme: "Bohemian Grove parody — the most powerful wizards meet annually in a forest with a forty-foot stone owl, claiming it's just networking. Guilds spy on the gathering to learn their plans.",
    tweet_1: "🦉 Every year the most powerful wizards in Nethara gather at Bonewood Grove.\n\nRobes. Rituals. An enormous stone owl.\n\nThey say it's just networking. Nobody networks in front of a forty-foot owl while chanting in unison.\n\nWhich guild uncovers the most about what they're planning?\nRally your guild — reply as your Nine! 🐱‍👤",
    ...
    tweet_3_prompt: "Build tension — more details leaking about what happens in the grove. The gathering is ending soon and all evidence will be magically sealed. Show updated standings. If it's close between top guilds, play up the race to uncover the most before the wards go back up.",
    tweet_4_prompt: "Resolve — the gathering ended. Attendees returned to their posts, refreshed and 'definitely not coordinating anything.' Announce winner as the guild that uncovered the most. The owl remains. It always remains. Show final scoreboard, name MVP. End with 'Full intel at 9lv.net'.",
...

  {
    ...
    theme: "JFK assassination parody — a beloved Archmagus struck down during a public procession. The Council says lone wizard from a tower, witnesses say the spell came from a grassy overlook. Guilds raid his now-unguarded library.",
    ...
    tweet_2_prompt: "Continue the Archmagus assassination story. A crystal recording was found but seventeen seconds are missing. The arrested wizard's connections to three noble houses are being quietly buried. Meanwhile the library is being raided by guilds. A bystander found a second spell trajectory that doesn't match the tower angle. Include live standings as a scoreboard of who's claiming the most tomes. Conspiratorial, dark tone.",
    tweet_3_prompt: "Escalate — the Council is about to seal the library and pave over the grassy overlook. Seventeen missing seconds will never be recovered. Create urgency. Show updated standings. If top guilds are close, play up the race for the last rare spellbooks.",
    tweet_4_prompt: "Resolve — the library has been picked clean and the overlook paved over. Announce winner as the guild that claimed the most valuable tomes. Official story remains: one wizard, one tower, one spell. Show final scoreboard, name MVP. End with 'Full intel at 9lv.net'.",
...

  {
    ...
    theme: "Area 51 parody — a warded mesa in the desert that's been sealed for decades. The wards flickered last night and something flew over a village — silent, fast, no wings. Guilds race to breach the mesa.",
...

  {
    ...
    theme: "Moon landing conspiracy parody — two wizards planted a banner on the highest peak but the banner fluttered where there should be no wind. Guilds race to the summit observatory for star-maps.",
    tweet_1: "🏔️ Two Nines from House Dawnbringer planted their banner on Silver Summit — the highest point in Nethara.\n\nThe whole realm watched through broadcast crystals.\n\nExcept some Nines are pointing out the banner fluttered where there should be no wind. And the shadows seem wrong.\n\nThe observatory up there has star-maps. Which guild claims them?\nRally your guild — reply as your Nine! 🐱‍👤",
    tweet_2_prompt: "Continue the Silver Summit story. A Nighthollow scholar released a twelve-scroll paper on 'shadow inconsistencies.' Dawnbringer is furious. One of the original climbers punched a doubter in a tavern. Meanwhile guilds are racing to the summit for the observatory data. Include live standings showing who's claiming the most star-map data. Mix conspiracy humor with adventure tone.",
    tweet_3_prompt: "Build urgency — the weather is closing in on the summit. Last chance to reach the observatory before the pass freezes. Show updated standings. If guilds are close, mention different routes to the top.",
    tweet_4_prompt: "Resolve — multiple guilds reached the summit. The banner is real, the observatory is real. Announce winner as the guild that claimed the most star-map data. The shadow debate continues in taverns. Show final scoreboard, name MVP. End with 'Full intel at 9lv.net'.",
...

  {
    ...
    theme: "Flat earth parody — a confident wizard says Nethara is flat and has organized an expedition to 'the edge.' Guilds profit from the accidentally useful exploration of new territory.",
    tweet_1: "🌍 A wizard from House Stonebark has gathered a following. He says Nethara is flat and he can prove it.\n\nHe's organised an expedition to 'the edge.' The Academy says there is no edge. He says the Academy is lying.\n\nHe has charts. The charts are very confident.\n\nWhich guild profits most from the new territory mapped along the way?\nRally your guild — reply as your Nine! 🐱‍👤",
...

  {
    ...
    theme: "Trump border wall parody — House Nighthollow building a tremendous wall and making House Dawnbringer pay for it. Guilds fight over the trade gate's tariff revenue.",
    tweet_1: "🧱 House Nighthollow is building a wall along the northern border. A big wall. They say it will be beautiful. The best wall Nethara has ever seen.\n\nAnd they're going to make House Dawnbringer pay for it.\n\nDawnbringer has declined. The wall just got ten feet higher.\n\nWhich guild controls the trade gate?\nRally your guild — reply as your Nine! 🐱‍👤",
    tweet_2_prompt: "Continue the wall story. The wall is forty feet of shadow crystal — impressive, frankly. 'Many people are saying it's the best wall.' Dawnbringer responded by building a ladder. Nighthollow added ten more feet. Include live guild standings. Trumpian bombast meets fantasy deadpan.",
...

  {
    ...
    theme: "COVID lockdown parody — a mysterious plague (definitely not from the Alchemist's Guild lab) leads to a 'two-week' lockdown that keeps extending. Guilds loot the abandoned quarantine zone.",
    ...
    tweet_2_prompt: "Continue the quarantine story. Week six of the 'two-week' lockdown. Nines baking enchanted bread. One hasn't worn proper robes in a month. Council recommends banging pots at sundown. The Guild laboratory has been 'quietly demolished — unrelated.' Include live guild standings. COVID humor, darkly funny.",
...

  {
    ...
    theme: "FTX collapse parody — a crystal exchange collapsed overnight, the Exchange Master fled on a flying carpet. Guilds race to breach the vaults.",
    ...
    tweet_2_prompt: "Continue the exchange collapse story. The Exchange Master spotted in the Palman Isles — no extradition. 'Cooperating from abroad' (from a beach, with a cocktail). His apprentice launching a new exchange — 'totally different,' same building, different sign. Include live guild standings. SBF/FTX energy.",
...

  {
    ...
    theme: "Rug pull parody — a merchant sold enchanted cloaks that turned to burlap overnight. His sign reads 'thank you for your liquidity.' Guilds loot his abandoned shop.",
    ...
    tweet_2_prompt: "Continue the rug pull story. Back room had maps, ledgers, merchant's next three stops — he's done this before. A Nine holding burlap says he's 'still early.' Include live guild standings. Crypto rug pull humor.",
...

  {
    ...
    tweet_2_prompt: "Continue the leviathan/whale story. Markets swinging wildly. Small traders panicking, large traders buying the panic. A Nine tried talking to it; it moved forty million crystals to a new vault. 'Probably nothing.' Include live guild standings. Crypto whale humor.",
...

  {
    ...
    theme: "Ponzi scheme / Madoff parody — a guild offered guaranteed 30% returns for a decade. There was never a vault. Guilds storm the building.",
...

  {
    ...
    theme: "DAO governance drama parody — a realm-wide vote went sideways. Someone bought 6,000 votes through shell guilds. Guilds stuff ballots.",
    ...
    tweet_2_prompt: "Continue the governance drama. A Nine proposed voting on whether to continue the vote — this passed. Then someone proposed voting on THAT vote. Three votes deep. A delegate filibustering by reading potion ingredients. The original question forgotten. Include live standings. DAO governance humor.",
...

  {
    ...
    theme: "Bear market depression parody — Frostfang Pass frozen for three seasons. A wizard with a frozen chart that 'only goes up.' Guilds break through ice to claim frozen cargo.",
...

  {
    ...
    theme: "Anchorman parody — rival broadcasters, a trident, jazz flute on the battlefield, an unexplained bear. Guilds claim abandoned equipment.",
    ...
    tweet_4_prompt: "Resolve — crystal wars over. Barely. Announce winner. Several Nines trapped in a glass case of emotion. Trident wizard still at large. Show final scoreboard, name MVP. End with 'Full intel at 9lv.net' — stay classy, Nethara.",
...

  {
    ...
    tweet_2_prompt: "Continue the roast story. A Smoulders joke about Stonebark so simple it circled back to devastating. A Nighthollow Nine stood in silence for thirty seconds — funniest thing all night. Crowd choosing sides. Mead running out. Include live standings. Sharp and cruel comedy energy.",
...

  {
    ...
    theme: "Lord of the Rings parody — a very small wizard carrying a corrupting artifact to a volcano. The fellowship has split. A walking tree. Guilds escort or intercept.",
...

  {
    ...
    tweet_4_prompt: "Resolve — scholars still arguing. Treasure was found. Announce winner as the guild that dug while everyone debated. The prophecy predicted this too — page four. Nobody read page four. Show final scoreboard, name MVP. End with 'Full intel at 9lv.net'.",
