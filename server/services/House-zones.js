...
const houses = {
  1: {
    name: 'House Smoulders',
    short: 'Smoulders',
    element: 'fire',
    color: '#E03C31',
    logo: 'House-smoulders.png',
  },
  2: {
    name: 'House Darktide',
    short: 'Darktide',
    element: 'water',
    color: '#00B4D8',
    logo: 'House-darktide.png',
  },
  3: {
    name: 'House Stonebark',
    short: 'Stonebark',
    element: 'earth',
    color: '#5CB338',
    logo: 'House-stonebark.png',
  },
  4: {
    name: 'House Ashenvale',
    short: 'Ashenvale',
    element: 'air',
    color: '#B0C4DE',
    logo: 'House-Ashenvale.png',
  },
  5: {
    name: 'House Stormrage',
    short: 'Stormrage',
    element: 'lightning',
    color: '#FFC800',
    logo: 'House-stormrage.png',
  },
  6: {
    name: 'House Nighthollow',
    short: 'Nighthollow',
    element: 'shadow',
    color: '#7B2D8E',
    logo: 'House-nighthollow.png',
  },
  7: {
    name: 'House Dawnbringer',
    short: 'Dawnbringer',
    element: 'light',
    color: '#FF8C00',
    logo: 'House-dawnbringer.png',
  },
  8: {
    name: 'House Manastorm',
    short: 'Manastorm',
    element: 'arcane',
    color: '#5B8FE0',
    logo: 'House-manastorm.png',
  },
  9: {
    name: 'House Plaguemire',
    short: 'Plaguemire',
    element: 'chaos',
    color: '#E84393',
    logo: 'House-plaguemire.png',
  },
};
