...
const HOUSE_BASE_STATS = {
  1: { name: 'Smoulders',   atk: 8, hp: 18, spd: 6 },
  2: { name: 'Darktide',    atk: 6, hp: 22, spd: 5 },
  3: { name: 'Stonebark',   atk: 4, hp: 28, spd: 3 },
  4: { name: 'Ashenvale',   atk: 5, hp: 20, spd: 8 },
  5: { name: 'Stormrage',   atk: 9, hp: 16, spd: 7 },
  6: { name: 'Nighthollow', atk: 7, hp: 20, spd: 5 },
  7: { name: 'Dawnbringer', atk: 5, hp: 24, spd: 4 },
  8: { name: 'Manastorm',   atk: 6, hp: 20, spd: 6 },
  9: { name: 'Plaguemire',  atk: 6, hp: 22, spd: 4 },
};
