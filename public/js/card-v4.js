...
var EFFECT_TIPS = {
  ...
  CRIT:    '50% chance to deal 1.5× ATK damage',
  SURGE:   '+3 ATK this combat cycle',
  PIERCE:  'Ignore enemy WARD shields',
  HEAL:    'Restore HP to lowest-HP ally',
  WARD:    'Absorb 3 damage from next hit',
  ANCHOR:  'Reduce all incoming damage by 2',
  THORNS:  'Attackers take 2 damage back',
  BARRIER: 'Separate shield with 5 HP pool',
  DRAIN:   'Deal 2 damage, heal self for 2',
  SIPHON:  'Steal 1 HP from target',
  WEAKEN:  'Target loses 3 ATK this cycle',
  HEX:     'Target loses 2 ATK this cycle',
  SILENCE: "Target's card effects don't activate",
  HASTE:   'Bonus attack at 50% damage after normal attack',
  SWIFT:   'First card of the day: effect doubled',
  DODGE:   '30% chance to avoid all damage',
  POISON:  'Damage per cycle, stacks with BURN',
  CORRODE: 'Enemy loses 2 max HP permanently in battle',
  INFECT:  'On KO, POISON spreads to all enemies',
  LEECH:   'Deal 2 damage, heal self for 1',
  AMPLIFY: '+2 ATK, next ally heal is 50% stronger',
  ...
  PHASE:   'Immune to all damage, but can\'t attack',
  MARK:    'Target takes 50% more damage from all sources',
  CLEANSE: 'Remove all debuffs from self',
  OVERCHARGE: '+50% ATK but take 20% HP recoil',
  SLOW:    '-3 SPD, 50% chance to skip attack',
  TAUNT:   'Force all enemies to target you',
  STEALTH: 'Can\'t be targeted by auto-attacks',
  STUN:    'Target can\'t attack or use effects',
